...
- APK: `apk/app-debug.apk`, версия `1.0.61`.
...
- Кнопки webview и APK: `npm test` проверяет `131` пункт, включая `data-action`, `approve/deny`, hover-кнопки сообщений, карточку изменений `undo/review/toggle`, `Ctrl+V`, `Enter`, `stop`, стартовые кнопки APK, меню текущего чата, вложения, голос и синхронизацию настроек composer.
...
Текущие версии:
- Android APK: 1.0.61, файл apk/app-debug.apk.
