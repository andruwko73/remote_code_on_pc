...
- Android APK: `1.0.101`.
- VS Code extension: `1.1.98`.
- Порт API по умолчанию: `8799`.
- Внешний доступ требует публичный URL и токен.
- Последняя проверка: `npm run compile`, `node test-extension.js` (`194/194`), `:app:testDebugUnitTest`, `:app:assembleRelease`, установка и запуск APK `1.0.101` на эмуляторе.
