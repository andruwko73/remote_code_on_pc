...
- APK: `apk/app-debug.apk`, версия `1.0.57`.
- VSIX: `extension/remote-code-on-pc-1.1.61.vsix`, версия `1.1.61`.
- APK raw URL: https://raw.githubusercontent.com/andruwko73/remote_code_on_pc/main/apk/app-debug.apk
- VSIX raw URL: https://raw.githubusercontent.com/andruwko73/remote_code_on_pc/main/extension/remote-code-on-pc-1.1.61.vsix
- Порт по умолчанию: `8799`.

Последняя проверка: `2026-05-04`.

- Расширение: `npm run compile`, `npx vsce package --allow-missing-repository`, установка VSIX, `/api/status` с `serverVersion: 1.1.61`.
...
```powershell
code --install-extension C:\Users\Admin\Documents\git\remote_code_on_pc\extension\remote-code-on-pc-1.1.61.vsix --force
```
После установки:
...
code --install-extension .\remote-code-on-pc-1.1.61.vsix --force
```
...
curl.exe -L -I https://raw.githubusercontent.com/andruwko73/remote_code_on_pc/main/extension/remote-code-on-pc-1.1.61.vsix
```
...
Текущие версии:
- Android APK: 1.0.57, файл apk/app-debug.apk.
- VS Code extension: 1.1.61, файл extension/remote-code-on-pc-1.1.61.vsix.
