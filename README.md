...
- Android APK: `1.0.102`.
- VS Code extension: `1.1.99`.
- Порт API по умолчанию: `8799`.
- Внешний доступ требует публичный URL и токен.
- Последняя проверка: `npm run compile`, `node test-extension.js`, `:app:testDebugUnitTest`, `:app:assembleRelease`, установка и запуск APK `1.0.102` на эмуляторе.
