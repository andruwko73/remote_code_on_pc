...
На Keenetic нужно настроить KeenDNS/публичный домен и проброс TCP-порта `8799` на IP ПК, где запущено расширение, например `192.168.1.112:8799`. Сервер расширения должен слушать `0.0.0.0:8799`.
