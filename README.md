...
- APK: `apk/app-debug.apk`, версия `1.0.49`.
- VSIX: `extension/remote-code-on-pc-1.1.45.vsix`, версия `1.1.45`.
- APK raw URL: https://raw.githubusercontent.com/andruwko73/remote_code_on_pc/main/apk/app-debug.apk
- VSIX raw URL: https://raw.githubusercontent.com/andruwko73/remote_code_on_pc/main/extension/remote-code-on-pc-1.1.45.vsix
...
```powershell
code --install-extension C:\Users\Admin\Documents\git\remote_code_on_pc\extension\remote-code-on-pc-1.1.45.vsix --force
```
После установки:
...
code --install-extension .\remote-code-on-pc-1.1.45.vsix --force
```
...
curl.exe -L -I https://raw.githubusercontent.com/andruwko73/remote_code_on_pc/main/extension/remote-code-on-pc-1.1.45.vsix
```
...
Текущие версии:
- Android APK: 1.0.49, файл apk/app-debug.apk.
- VS Code extension: 1.1.45, файл extension/remote-code-on-pc-1.1.45.vsix.
