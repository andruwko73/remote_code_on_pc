...
val AccentBlueLight = Color(0xFF1A8CFF)
...
val TextBright = Color(0xFFE0E0E0)
val TextLink = Color(0xFF3794FF)

val ErrorRed = Color(0xFFF14C4C)
val WarningYellow = Color(0xFFCCA700)
val InfoBlue = Color(0xFF3794FF)
